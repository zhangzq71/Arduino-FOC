...
The <span class="simple">Simple<span class="foc">FOC</span>library</span> supports Arduino and STM32 devices *off-the-shelf*, using Arduino IDE, and with small modifications many more... 
...
This library has been ported to Maple boards, ESP32 boards, Arduino DUEs even to strom32 BGC v1.31, so I hope to be able to support much more boards in future. 😃
...
Arduino UNO and Arduino MEGA are probably the most commonly used with this library. The simplicity of using these boards si incomparable. If you are planning to run this library with the Arduino UNO I would certainly suggest you to think about using Magnetic sensors instead of encoders. Encoders are highly inefficient sensors (at least their implementation for Arduino UNO & MEGA) and due to constant counting the interrupt signals of the encoder produces a large difference of execution time depending on velocities you are driving your motor. 
