...
The <span class="simple">Simple<span class="foc">FOC</span>library</span> supports Arduino and STM32 devices off the shelf, using Arduino IDE, and with small modifications probably many more. 
